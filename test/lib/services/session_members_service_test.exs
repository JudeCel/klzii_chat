defmodule KlziiChat.Services.SessionMembersServiceTest do
  ...
  test "group_by_role" do
    ...
    members = [
      %{id: 1, role: "facilitator", username: "1", colour: "a", online: true, avatarData: "q", sessionTopicContext: %{}, sessionContext: %{}, currentTopic: {}, account_user: %{ firstName: "name1", lastName: "name2"}},
      %{id: 2, role: "observer", username: "2", colour: "b", online: false, avatarData: "w", sessionTopicContext: %{}, sessionContext: %{}, currentTopic: {}, account_user: %{ firstName: "name1", lastName: "name2"} },
      %{id: 3, role: "participant", username: "3", colour: "c", online: true, avatarData: "e", sessionTopicContext: %{}, sessionContext: %{}, currentTopic: {}, account_user: %{ firstName: "name1", lastName: "name2"} }
    ]
