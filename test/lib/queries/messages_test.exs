defmodule KlziiChat.Queries.MessagesTest  do
  ...
  setup %{session_topic_1: session_topic_1, member: member, member2: member2} do
    ...
    {:ok, base_query: base_query, base_query_star_only: base_query_star_only, member: member, member2: member2, create_date1: create_date1, create_date2: create_date2}
  end
  ...
  test "sort and select from all messages", %{base_query: base_query, create_date1: create_date1,
    create_date2: create_date2, member: %{username: username1}, member2: %{username: username2}} do
    [message1, message2] =
      base_query
      |> QueriesMessages.join_session_member()
