defmodule KlziiChat.Authorisations.Channels.SessionTopicTest do
  ...
  test "Session Topic authorisation succses #authorized?", %{session_topic_1: session_topic_1, member: member} do
    sesssion_topic_id =  session_topic_1.id
    session_member =  %{id: member.id, session_id: session_topic_1.sessionId}
  ...
  test "Session Topic authorisation Fails #authorized?", %{session_topic_1: session_topic_1, member: member} do
