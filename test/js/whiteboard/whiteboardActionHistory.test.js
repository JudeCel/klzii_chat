...
describe("testWhiteboard", ()=> {
  ...
  it("Test Whiteboard undo history", () => {
    ...
    undoHistoryFactory.addStepToUndoHistory(step1Object);
    undoHistoryFactory.addStepToUndoHistory(step2Object);
    undoHistoryFactory.addStepToUndoHistory(step3Object);
    ...
    undoHistoryFactory.addStepToUndoHistory(step5RedoObject);
