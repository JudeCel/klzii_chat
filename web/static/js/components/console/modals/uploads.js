...
const UploadsConsole = React.createClass({
  ...
  render() {
    ...
    //this is temp solution, should be redesigned with normal resources logic when client provides 2 final videos
    if (sessionTopicConsole.consoleResource.type == "link" 
      && sessionTopicConsole.consoleResource.source == "vimeo" 
      && (sessionTopicConsole.consoleResource.url.full == "187585089" || sessionTopicConsole.consoleResource.url.full == "187510116") 
      && this.isMobileBrowser())
    {
      sessionTopicConsole.consoleResource.url.full = "255661777";
      sessionTopicConsole.consoleResource.name = sessionTopicConsole.consoleResource.name.replace(" Video", " Mobile Video")
    }
